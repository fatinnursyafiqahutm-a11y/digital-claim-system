            ...
            <div class="flex items-center px-6 pt-4 pb-2">
                <div class="flex items-center space-x-2">
                    ...
                    @if(($unreadCount ?? 0) > 0)
                        ...
                        <form method="POST" action="{{ route('employee.claims.mark-all-read') }}" class="ml-3">
                            @csrf
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-8 py-4 whitespace-nowrap text-left">
                                            <div class="flex items-start space-x-3">
                                                <span class="mt-2 w-2 h-2 rounded-full {{ $claim->is_read ? 'bg-transparent' : 'bg-red-500' }}"></span>
                                                <div>
